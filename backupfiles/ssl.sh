...
_INSTALL(){
  ...
  cd /root/.acme.sh/
  ./acme.sh --server https://acme-v02.api.letsencrypt.org/directory --register-account --accountemail 'u201413794@gmail.com'
  export CF_Key="2721a50b7beaa571d9ed25fc63ce3fb31b14c"
  export CF_Email="u201413794@gmail.com"
  ./acme.sh --server https://acme-v02.api.letsencrypt.org/directory --issue -d $domain --dns dns_cf --force
  sleep 5
