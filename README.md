...
## scaleway ipv6 Only VPS to setup naiveproxy apt update && apt install -y curl && bash <(curl -Ls https://raw.githubusercontent.com/U201413497/script/main/trojango/trojango.sh)
